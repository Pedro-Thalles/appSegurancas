...
Sistema web desenvolvido para o gerenciamento de agentes de segurança, controle de acesso a funcionalidades e fluxo de aprovação de cadastros para a Secretaria de Estado da Segurança Pública (SSP/SE).
